...
insert  into `accommodation`(`ID`,`Start_time`,`End_time`,`bed_id`,`principal`,`operate_time`,`remarks`) values (1,'2020/1/2','2020/1/22',1,2,'2019-01-02',NULL),(2,'2020/5/6','2020/6/6',3,2,'2015-01-02',NULL),(3,'2021/4/9','2021/4/10',45,2,'2012-01-02',NULL),(4,'2021/6/9','2021/6/16',37,3,'2016-01-02',NULL),(5,'2021/6/26','2021/8/2',58,1,'2018-01-02',NULL);
...
insert  into `answer`(`ID`,`QuestionID`,`Content`,`Delmark`,`User_ID`,`remarks`) values (1,10,'腰酸背痛，需要日常中医药护理',1,2,NULL),(2,10,'需要进行腿部肌肉日常康复训练',1,3,NULL),(3,3,'子女满堂，经常探望',1,3,NULL),(4,4,'有慢性病，痰多咳嗽，慢性鼻炎',1,4,NULL),(5,5,'没有突发疾病，偶尔心绞痛',1,1,NULL),(6,6,'具有家族遗传心血管疾病',0,5,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2206 DEFAULT CHARSET=utf16;

/*Data for the table `bed` */

insert  into `bed`(`ID`,`Number`,`State`,`Room_ID`,`Room_Clean`,`Delmark`,`remarks`) values (1,12021,0,1,'2022/6/1',1,NULL),(2,12022,1,2,'2022/6/2',1,NULL),(3,12043,1,3,'2022/6/3',1,NULL),(4,22036,0,4,'2022/6/4',1,NULL),(5,22052,1,5,'2022/6/5',1,NULL),(6,12041,1,6,'2022/5/29',1,NULL),(7,12042,1,7,'2022/5/30',1,NULL);
...
insert  into `doctor_chart`(`principal`,`doctor_num`,`name`,`age`,`work_year`,`Account`,`password`,`gender`,`birthday`,`Title`,`department`,`Delmark`,`remarks`) values (1,125,'王普普',34,'10','cookies','679543','女','1988/8/5','医生','内科','1',NULL),(2,246,'卢晓晶',43,'15','xiaoxiao','492873','女','1979/6/8','护士','内科','1',NULL),(3,576,'齐豪',32,'9','qihao','240250','男','1990/10/18','医生','外科','1',NULL),(4,580,'陈大大',35,'11','dada','537468','男','1987/12/1','医生','外科','1',NULL),(5,325,'张正湘',57,'29','zhengxiang','493756','男','1965/3/30','护士','外科','1',NULL),(6,254,'卓英',39,'6','ying','785375','女','1983/6/21','护士','外科','1',NULL),(7,511,'刘衡',58,'30','heng','900546','男','1964/9/10','护士','外科','1',NULL);
...
insert  into `patient`(`User_ID`,`patient_name`,`gender`,`principal`,`load_time`,`Idcard`,`home_address`,`phone`,`Account`,`Password`,`Delmark`,`remarks`) values (1,'李欣然','男',1,'2019/1/2','130925199106132615','河北省沧州市盐山县','14176507219','xinran','135985',1,NULL),(2,'齐小豪','女',2,'2015/1/2','360428197205147527','江西省九江市都昌县','17890346177','xiaohao','946284',1,NULL),(3,'雷凡凡','男',3,'2012/1/2','350322197801261718','福建省莆田市仙游县','19340038054','fanfan','246891',1,NULL),(4,'吴天天','女',3,'2016/1/2','44172119720310362X','广东省阳江市阳西县','18120244613','tiantian','324235',1,NULL),(5,'陈达达','女',3,'2018/1/2','510623198601073613','四川省德阳市中江县','18379413070','dada','435788',1,NULL);
...
insert  into `question`(`ID`,`Title`,`DelMark`,`Module_Name`,`remarks`) values (1,'您的问题是位于哪一部位？',1,0,NULL),(2,'您是否存在行动障碍？',1,0,NULL),(3,'您的子女是否经常探望？',1,0,NULL),(4,'您是否存在慢性病？',1,0,NULL),(5,'您是否患有突发疾病？',1,0,NULL),(6,'您是否有家族遗传病',1,0,NULL),(7,'您是否拥有残疾证',1,0,NULL),(8,'您是否拥有基本的自理能力',1,0,NULL),(9,'您是否拥有精神疾病',1,0,NULL),(10,'您或者您的家人是否需要特殊护理人员',1,0,NULL);
...
insert  into `rare_equipment_management_table`(`ID`,`equipment_name`,`equipment_type`,`in_use`,`Delmark`,`Room_ID`,`remarks`) values (1,'呼吸机','医疗型',1,1,4,NULL),(2,'呼吸机','医疗型',0,1,1,NULL),(3,'麻将桌','娱乐型',0,1,2,NULL),(4,'麻将桌','娱乐型',0,1,3,NULL),(5,'心电图机','医疗型',0,1,5,NULL),(6,'心电图机','医疗型',0,1,6,NULL),(7,'血压仪','医疗型',0,1,7,NULL);
...
insert  into `rare_equipment_use_table`(`ID`,`Start_time`,`End_time`,`user_ID`,`remarks`) values (1,'2022-6-1','2022-6-11',1,NULL),(2,'2022-6-2','2022-6-3',2,NULL),(3,'2022-6-3','2022-6-6',3,NULL),(4,'2022-6-4','2022-6-9',4,NULL),(5,'2022-6-5','2022-6-6',2,NULL),(6,'2022-6-6','2022-6-8',1,NULL);
...
insert  into `room`(`ID`,`Type`,`Max`,`Remark`,`department`,`Room_ID`,`principal`,`Delmark`,`remarkS`) values (1,1,4,'阳面靠近楼梯',3,1201,5,0,NULL),(2,1,4,'阴面靠近楼梯',3,1202,7,1,NULL),(3,1,3,'阳面有卫浴',3,1204,2,1,NULL),(4,2,1,'阴面',0,2203,1,1,NULL),(5,2,2,'阴面',1,2205,3,1,NULL),(6,3,10,'阳面拐角',2,3101,6,1,NULL),(7,4,10,'阴面朝南',4,4101,4,1,NULL);
