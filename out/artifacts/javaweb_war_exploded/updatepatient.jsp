        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="patientname" value="${patientmodel.patientName}" class="span11" placeholder="请输入姓名" maxlength="10"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">性别 :</label>
              <div class="controls">
                <input type="text" name="gender" value="${patientmodel.gender}" class="span11" placeholder="请输入性别" maxlength="1"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="DID">
                  <option value="${patientmodel.principal}">不变</option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div  data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text" name="date" value="${patientmodel.loadTime}"  data-date-format="mm-dd-yyyy" class="span11" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="PID" value="${patientmodel.idCard}" class="span11" placeholder="请输入身份证信息" maxlength="18"/>
              </div>
            </div>
              <div class="control-group">
                <label class="control-label">地址 :</label>
                <div class="controls">
                  <input type="text" name="address" value="${patientmodel.homeAddress}" class="span11" placeholder="请输入家庭地址" maxlength="20"/>
                </div>
              </div>
                <div class="control-group">
                  <label class="control-label">电话 :</label>
                  <div class="controls">
                    <input type="text" name="phone" value="${patientmodel.phone}" class="span11" placeholder="请输入联系方式" oninput="value=value.replace(/[^\d]/g,'')" maxlength="11"/>
                  </div>
                </div>
